export const resources = [
  {
    id: 1,
    title: "Guía para dejar de fumar de la OMS",
    description:
      "Un completo recurso de la Organización Mundial de la Salud con estrategias y consejos para dejar de fumar.",
    image:
  ...
  {
    id: 3,
    title: "Blog de la Asociación Americana del Pulmón",
    description:
      "Recursos y consejos para dejar de fumar y mejorar la salud pulmonar.",
    image:
  ...
  {
    id: 4,
    title: "Blog Quit Smoking Community",
    description:
      "Una comunidad de apoyo con artículos y recursos para dejar de fumar.",
    image:
